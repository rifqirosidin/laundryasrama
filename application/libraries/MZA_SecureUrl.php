...
class MZA_SecureUrl{
	...
	function MZA_SecureUrl(){
		...
		$this->valid_url = md5('erp sci itt');  // you can change the string
		$this->parse	 = 'erp sci itt';  // you can change the string
		$this->length	 = 7;  // you can change the value. Min : 1, Max : 32;
		$this->point1	 = 7;  // you can change the value. Min : 1, Max : point1 + length : 32
		$this->point2	 = 19;  // you can change the value. Min : 1, Max : point2 + length : 32
	}
