	...
	<div class="art-content-layout-row">
		<div class="art-layout-cell art-content">
			<div class="art-post">
				...
				<!-- MULAI KONTEN -->
							<fieldset><legend>INVENTORI</legend>
								<?php echo $link; ?> &nbsp; &nbsp; <a class="add" id="add-stok">Tambah Stok Gudang</a> &nbsp; &nbsp; <a class="view" id="add-jstok">Jenis Inventori</a><br/><br/>
								<?php echo ! empty($table_stok) ? $table_stok : ''; ?>
								<?php $this->load->view('admin/setting/stok_form'); ?>
								<?php $this->load->view('admin/setting/stok_jenis'); ?>
							</fieldset>
