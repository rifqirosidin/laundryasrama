		...
		<div class="art-layout-cell art-content">
			<div class="art-post">
				...
				<!-- MULAI KONTEN -->
							...
							<fieldset><legend>SMS Broadcast</legend>
								<?php echo $eventSMS; ?><br/><br/>
								<div class="pesan">
							<?php if($pesan !== NULL) { ?>
									<div class="judul"><?php echo $pesan->nama_broad; ?></div>
									<div class="isi"><?php echo $pesan->text_broad; ?></div>
							<?php }else{ ?>
									<div class="kosong">- PILIH PESAN YANG INGIN ANDA BACA -</div>
							<?php } ?>
								</div><br/>
								<?php echo ! empty($tableBroad) ? $tableBroad : ''; ?>
							</fieldset>
