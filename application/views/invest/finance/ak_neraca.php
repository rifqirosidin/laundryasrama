		...
		<div class="art-layout-cell art-content">
			<div class="art-post">
				...
				<!-- MULAI KONTEN -->
							...
							<fieldset><br/>
							<form name="neraca_form" method="post" action="<?php echo $form_neraca; ?>" accept-charset="utf-8">
								<table width='45%' style='font-weight:bold;'>
									...
									<tr>
										...
										<td style="text-align:right;"><a class="tombol" href="javascript:document.neraca_form.submit()">Tampilkan</a></td>
									</tr>
								</table>
							</form><br/>
							<div class="list">NERACA : <?php echo $nama_outlet; ?></div><br/>
							<?php echo ! empty($tabelAset) ? $tabelAset : ''; echo ! empty($tabelWajib) ? $tabelWajib : ''; ?>
							</fieldset>
