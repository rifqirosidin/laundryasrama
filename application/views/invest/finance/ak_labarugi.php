		...
		<div class="art-layout-cell art-content">
			<div class="art-post">
				...
				<!-- MULAI KONTEN -->
							...
							<fieldset><br/>
							<form name="lr_form" method="post" action="<?php echo $form_lr; ?>" accept-charset="utf-8">
								<table width='45%' style='font-weight:bold;'>
									...
									<tr>
										...
										<td style="text-align:right;"><a class="tombol" href="javascript:document.lr_form.submit()">Tampilkan</a></td>
									</tr>
								</table>
							</form><br/>
							<div class="list">LAPORAN LABA RUGI : <?= $nama_outlet; ;?></div><br/>
							<?php echo ! empty($tabelLR) ? $tabelLR : ''; ?>
							</fieldset>
