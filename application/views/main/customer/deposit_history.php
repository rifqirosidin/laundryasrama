<head>
	<title>Waroenk Laundry | History Deposit</title>
...
<body>
	...
	<?php $i=0;
		foreach($tRow as $row){
			...
			<tr>
				<td><?php echo ++$i; ?></td>
				<td><?php echo $row->dresi; ?></td>
				<td style="text-align:left;padding-left:10px;"><?php echo $row->jenis_deposit; ?></td>
				<td><?php echo $row->jumlah_deposit; ?></td>
				<td><?php echo $row->tgl_depo; ?></td>
			</tr>
	<?php 	}else
				break;
		} ?>
